...
# a HuggingFace en arranques posteriores.
...
# Un solo proceso Uvicorn por contenedor (recomendación oficial de FastAPI para
# Docker/Kubernetes: https://fastapi.tiangolo.com/deployment/server-workers/).
# Escalar horizontalmente se hace con más réplicas del contenedor, no con
