...
_E = {
    ...
    "notificationevent":  (
        ...
        "provider_degraded", "provider_misconfigured", "unanswered_digest",
...
def upgrade() -> None:
    ...
    _ct(
        ...
        sa.Column("granted_at",    mysql.DATETIME(fsp=6), server_default=sa.text("CURRENT_TIMESTAMP(6)"), nullable=False),
    ...
    _ct(
        ...
        sa.Column("requires_api_key",      sa.Boolean,     nullable=False, server_default=sa.true()),
    ...
    _ct(
        ...
        sa.Column("edited_at",        mysql.DATETIME(fsp=6), server_default=sa.text("CURRENT_TIMESTAMP(6)"), nullable=False),
    )
    ...
    _ct(
        ...
        sa.Column("created_at",                  mysql.DATETIME(fsp=6), server_default=sa.text("CURRENT_TIMESTAMP(6)"), nullable=False),
        sa.Column("started_at",                  mysql.DATETIME(fsp=6), server_default=sa.text("CURRENT_TIMESTAMP(6)"), nullable=False),
        sa.Column("last_message_at",             mysql.DATETIME(fsp=6), server_default=sa.text("CURRENT_TIMESTAMP(6)"), nullable=False),
    ...
    _ct(
        ...
        sa.Column("recorded_at",  mysql.DATETIME(fsp=6), server_default=sa.text("CURRENT_TIMESTAMP(6)"), nullable=False),
